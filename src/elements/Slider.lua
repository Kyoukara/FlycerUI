...
function Element:New(Config)
	...
	local CurInput = Config.FlycerUI.GenerateGUID()
	...
	Creator.AddSignal(Slider.UIElements.SliderContainer.InputBegan, function(input)
		...
		if
			...
			or input.UserInputType == Enum.UserInputType.Touch
		then
			if Config.FlycerUI.CurrentInput and Config.FlycerUI.CurrentInput ~= CurInput then
				return
			end
			Config.FlycerUI.CurrentInput = CurInput

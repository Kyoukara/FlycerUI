...
function ScrollSlider.New(ScrollingFrame, Parent, Window, Thickness, FlycerUI)
	...
	local function StopDrag()
		if FlycerUI.CurrentInput == ScrollSliderActionId then
	...
	Creator.AddSignal(Hitbox.InputBegan, function(input)
		...
		if FlycerUI.CurrentInput and FlycerUI.CurrentInput ~= ScrollSliderActionId then
			return
		end

		FlycerUI.CurrentInput = ScrollSliderActionId

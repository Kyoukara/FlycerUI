...
local function OpenFlycerServiceDialog(
	...
	-- DIALOUGE ICON (Menyelaraskan dengan icon utama KeySystem)
	...
	-- Container Icon dan Judul untuk Dialog Pop-up
	...
	New("Frame", {
		...
		DialogTitleContainer, -- Menerapkan Container Ikon dan Judul baru
		Description,
		Buttons,
		New("UIPadding", {
